...
> Question: How could we make sure that we moved? Type in pwd and make sure your new working directory is the one you just changed to.
...
> Hint: we learned how to list all the files up above. The "HELLO WORLD" is being written directly into the file rather than in the terminal.
...
would we do that? curl https://archive.ics.uci.edu/ml/machine-learning-databases/auto-mpg/auto-mpg.data > test_file.txt
...
> What changed? Instead of the file size being 30286, it is now rounded to 30K.
